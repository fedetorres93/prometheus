...
| <code class="text-nowrap">--promql.utf8_broad_lookup.escape_formats</code> | method to escape legacy invalid names when sending to an old version of prometheus.  can be one of values (default), underscores, or dots | `values` |
